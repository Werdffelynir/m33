...
export class ExtrudeHolesComponent extends ReaComponent {
    ...
    createRender () {
        ...
        const shape = this.createCurveShapeStructure_E()
        scene.add(shape)
    ...
    createCurvePathByPoints (curvePath, pointsArr, x = 0, y = 0, scale = 1) {
...
// 3. Налаштування екструзії
    ...
    createCurveShapeStructure_E ( scale = 1 ) {
