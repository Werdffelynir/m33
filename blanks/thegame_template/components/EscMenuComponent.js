...
export class EscMenuComponent extends ReaComponent {
    ...
    create() {
        ...
        // Theater3DController TheaterController
        this.menulist = [
            {
            ...
            {
                title: 'Theater Scene 2D',
                onclick: async (payload) => await switchController(Theater2DController.name)
            },
            {
                title: 'Theater Scene 3D',
                onclick: async (payload) =>  await switchController(Theater3DController.name)
            },
        ];
