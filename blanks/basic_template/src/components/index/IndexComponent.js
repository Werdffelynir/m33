...
export class IndexComponent extends ReaComponent {
    create() {
...
// div: "{{title}}"
//   div
//     img.w200px[src=/resources/images/sprite.png]
// `;
...
// /*                     EXAMPLES                       */
//
// const HTML_STATIC_LAYERS = ``;
// const CSS_STATIC_LAYERS = `
// div
// `;
...
//
//         super.create({
//             template: HTML_STATIC_LAYERS,
//             css: CSS_STATIC_LAYERS,
//             state: {...this.props.state, ...{title: this.constructor.name} },
//         });
//
